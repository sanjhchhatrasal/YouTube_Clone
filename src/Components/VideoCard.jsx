...
const VideoCard = ({ item }) => {
  ...
  return (
    <>
      {sidebar ? (
        <div className="lg:h-[23vw] lg:w-[25vw] sm:h-[40vh] sm:w-[35vw]  h-[30vh] w-[40vw] overflow-hidden">
          <div className="lg:h-[60%] sm:h-[70%] h-[65%] rounded-lg w-full bg-zinc-800 overflow-hidden">
            <img
          ...
          <div className="flex lg:gap-3 gap-1 lg:py-3 py-1 items-start">
            <div className="sm:h-10 sm:w-10 h-7 w-7 rounded-full overflow-hidden bg-zinc-900">
              <img
            ...
            <div className="sm:w-[80%] w-[77%] ">
              <h1 className="sm:text-lg text-[0.65rem] font-semibold">
                {truncateTitle(item.snippet.title, 10)}
              </h1>
              <h2 className="sm:text-sm text-[0.6rem] font-semibold text-gray-400 ">
        ...
        <div className="lg:h-[18vw] md:h-[30vh] md:w-[44vw]  h-[42vh] w-[97vw] lg:mb-0 mb-2 lg:w-[20vw] lg:m-0 overflow-hidden">
          ...
          <div className="flex lg:gap-3 gap-2 lg:py-3 py-1 items-start">
            <div className="md:h-10 md:w-10 h-9 w-9 rounded-full overflow-hidden  bg-zinc-800">
              <img
                className="h-full w-full object-cover "
            ...
            <div className="lg:w-[80%] w-[77%] ">
              ...
              <h2 className="md:text-xs text-xs font-semibold text-gray-400  ">
                {item.snippet.channelTitle}
              </h2>
